...
public class RandomCubeMovement : MonoBehaviour
{
    ...
    for (int i = 0; i < numberOfCubes; i++)
    {
        ...
        // Pass planeSize and player reference when initializing DirectionMovement
        cube.AddComponent<DirectionMovement>().Initialize(moveSpeed, directionChangeInterval, planeSize, playerCube);
